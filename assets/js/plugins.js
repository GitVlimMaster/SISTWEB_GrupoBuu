...
(function(jQuery) {
    ...
    jQuerywindow.resize(function() { windowHeight = jQuerywindow.height(); });
    ...
    e.fn.fitVids = function(t) { var n = { customSelector: null }; var r = document.createElement("div"),
        ...
        i.parentNode.insertBefore(r, i); if (t) { e.extend(n, t) } return this.each(function() { var t = ["iframe[src*='player.vimeo.com']", "iframe[src*='www.youtube.com']", "iframe[src*='www.youtube-nocookie.com']", "iframe[src*='www.kickstarter.com']", "object", "embed"]; if (n.customSelector) { t.push(n.customSelector) } var r = e(this).find(t.join(","));
            r.each(function() { var t = e(this); if (this.tagName.toLowerCase() === "embed" && t.parent("object").length || t.parent(".fluid-width-video-wrapper").length) { return } var n = this.tagName.toLowerCase() === "object" || t.attr("height") && !isNaN(parseInt(t.attr("height"), 10)) ? parseInt(t.attr("height"), 10) : t.height(),
                ...
                t.removeAttr("height").removeAttr("width") }) }) } })(jQuery); /*!matchMedia() polyfill - Test a CSS media type/query in JS. Authors & copyright (c) 2012: Scott Jehl, Paul Irish, Nicholas Zakas, David Knight. Dual MIT/BSD license*/
...
(function(c) { var n = -1,
        ...
        b = c.fn.matchHeight = function(a) { a = p(a); if (a.remove) { var e = this;
                this.css(a.property, "");
    ...
    b._afterUpdate = null;
    b._apply = function(a, e) { var d = p(e),
            h = c(a),
            k = [h],
        ...
        c.each(k, function(a, b) { var e = c(b),
                f = 0; if (d.target) f = d.target.outerHeight(!1);
    ...
    b._applyDataApi = function() { var a = {};
        ...
        c.each(a, function() { this.matchHeight(!0) }) }; var q = function(a) { b._beforeUpdate && b._beforeUpdate(a, b._groups);
    ...
    c(window).bind("resize orientationchange", function(a) { b._update(!0, a) }) })(jQuery);
