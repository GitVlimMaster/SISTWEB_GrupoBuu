                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="themesflat-headings style-1 text-center wow fadeInUp clearfix">
                                <h1 class="heading">SERVICIOS PARA TI</h1>
                                <p class="sub-heading">GRUPO BUU <br> Somos recicladores, realizamos recolecciones de scrap, fabricantes de artículos de hule, renta de montacargas</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class=" box-service wow fadeInDown ">
                            <div class="service-inner-img">
                                ...
                                <a href="buupets.php"><img src="assets\img\portada.PNG" alt="Image"></a>      
                            </div>
                            <div class="service-inner-text">
                                <div></div>
                                <br><br>
                                <div class="text-wrap">
                                    <h3 class="heading"><a href="buupets.php">BUUPETS</a></h3>
                                    <div class="sep clearfix"></div>
                                    <p class="sub-heading">Conoce más sobre nuestros productos, tips para tu mascota y más en nuestras redes sociales.</p>
                                </div>
                                <a href="buupets.php" class="service-read-more">Más Información<i class="fa fa-arrow-right"></i> </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <div class="box-service wow fadeInUp ">
                            ...
                            <div class="service-inner-text">
                                <div></div>
                                <div class="text-wrap">
                                    <h3 class="heading"><a href="service-detail.html"></a></h3>
                                    <div class="sep clearfix"></div>
                                    <p class="sub-heading"></p>
                                    <a href="service-detail.html" class="service-read-more"></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <div class="box-service wow fadeInDown ">
                            <div class="service-inner-img">
                                <div class="img-overlay"></div>
                                <a href="suelas.php"><img src="assets\img\portada2.PNG" alt="Image"></a>                            
                            </div>
                            <div class="service-inner-text">
                                <div></div>
                                <br><br>
                                <div class="text-wrap">
                                    <h3 class="heading"><a href="suelas.php">SUELAS TEGO</a></h3>
                                    <div class="sep clearfix"></div>
                                    <p class="sub-heading">Descripción</p>
                                    <a href="suelas.php" class="service-read-more">Más Información <i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row-experiences ">
            <div class="container">
                <div class=" row-experiences-content wow zoomInDown">
                    <div class="row">
                        <h1 class="heading-experiences">MATERIALES QUE RECICLAMOS</h1>
                    </div>
                    <div class="row">
                        <div class="link wow fadeInRight">
                            <div class="link-1">
                                <ul>
                                    <li class="left"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Hule</a></li>
                                    <li class="left"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Plásticos de ingeniería y comodities</a></li>
                                    <li class="left"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Cualquier tipo de material, nos adaptamos
                                            <br> a los residuos que generen las empresas a la cual
                                            <br> estamos ofreciendo el servicio.</a></li>
                                </ul>
                            </div>
                            <div class="link-2">
                                <ul>
                                    <li class="right"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Cartón</a></li>
                                    <li class="right"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Madera</a></li>
                                </ul>
                            </div>
                            <div class="link-1">
                                <ul>
                                    <li class="left"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Papel</a></li>
                                    <li class="left"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Vidrio</a></li>
                                </ul>
                            </div>
                            <div class="link-2">
                                <ul>
                                    <li class="right"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Madera</a></li>
                                    <li class="right"><a href="service-detail.html"><i class="zingbox-icon-check"></i>Chatarra </a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
...
<div class="img-overlay"> </div>
<img src="assets\img\shortcode\team\team-1.jpg" alt="Image">
<div class="box box1">
...
<div class="img-overlay"> </div>
<img src="assets\img\shortcode\team\team-2.jpg" alt="Image">
<div class="box box2">
...
<div class="img-overlay"> </div>
<img src="assets\img\shortcode\team\team-3.jpg" alt="Image">
<div class="box">
...
<div class="box-team wow fadeInDown">
<div class="img-overlay"> </div>
<img src="assets\img\shortcode\team\team-4.jpg" alt="Image">
<div class="box">
